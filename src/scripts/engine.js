const state = {
  ...
  actions: {
    buttoon: document.getElementById("next-duel"),
  },
};
...
async function drawButton(text) {
  state.actions.buttoon.innerText = text;
  state.actions.buttoon.style.display = "block";
}
...
async function resetDuel() {
  state.cardSprites.avatar.src = "";
  state.actions.buttoon.style.display = "none";
